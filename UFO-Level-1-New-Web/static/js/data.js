var data = [{
  ...
  // Adding additional data to test if it can be loaded onto the website
  {
    datetime: "4/14/1561",
    city: "Nuremberg",
    state: "unknown",
    ...
    shape: "unknown",
    durationMinutes: "unknown",
    comments: "Residents of Nuremberg saw what they described as an aerial battle, followed by the appearance of a large black triangular object and then a large crash outside of the city. The broadsheet claims that witnesses observed hundreds of spheres, cylinders and other odd-shaped objects that moved erratically overhead."
  },
  {
    datetime: "4/17/1897",
    city: "Aurora",
